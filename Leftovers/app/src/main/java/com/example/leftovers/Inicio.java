...
public class Inicio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        in_recetas = new Intent(this, Recetas.class);
        in_ingredientes = new Intent(this, ListaMisIngredientes.class);
        in_elementos = new Intent(this, MisElementos.class);
        in_lista_compras = new Intent(this,ListaCompra.class);
        in_agregar_ingrediente = new Intent(this, Categorias.class);
        in_agregar_elemento = new Intent(this, Elementos.class);
        ...
        cv_ingredientes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(in_ingredientes);
            }
        });
        cv_agregar_elemento.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(in_agregar_elemento);
            }
        });
        cv_elementos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(in_elementos);
            }
        });

        cv_recetas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(in_recetas);
            }
        });
